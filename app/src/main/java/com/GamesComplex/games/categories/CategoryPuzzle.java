...
public class CategoryPuzzle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.category_puzzle_view);

        gridView = findViewById(R.id.PuzzleGrid);
        Admob.BannerAds(findViewById(R.id.PuzzleBanner), CategoryPuzzle.this);

        Admob.FullscreenAd(CategoryPuzzle.this);


        GameHomeList.PuzzleList();
        PuzzleAdapter adapter = new PuzzleAdapter();
    ...
    private class PuzzleAdapter extends BaseAdapter {
        ...
        public PuzzleAdapter() {
            this.inflater = (LayoutInflater) CategoryPuzzle.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        }
        ...
        public View getView(final int i, View view, ViewGroup viewGroup) {
            ...
            String PuzzleName = mHashMap.get("PuzzleName");
            String PuzzleImg = mHashMap.get("PuzzleImg");
            String PuzzleUrl = mHashMap.get("PuzzleUrl");

            if (tvTitle != null) tvTitle.setText(PuzzleName);
            if (imgIcon != null && PuzzleImg != null) {
                int drawable = Integer.parseInt(PuzzleImg);
            ...
            if (layItemView != null) {
                layItemView.setOnClickListener(v -> {
                    if (PuzzleUrl != null && PuzzleUrl.length() > 5) {
                        GameLoader.game_url = PuzzleUrl;
                        targetActivity = new Intent(CategoryPuzzle.this, GameLoader.class);
                    ...
                    if (Admob.mInterstitialAd == null) startActivity(targetActivity);
                        ...
                        startActivity(targetActivity);
                    else Admob.mInterstitialAd.show(CategoryPuzzle.this);
