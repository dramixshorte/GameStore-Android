...
public class CategorySports extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.category_sports_view);

        gridView = findViewById(R.id.SportsGrid);
        Admob.BannerAds(findViewById(R.id.SportsBanner), CategorySports.this);
        Admob.FullscreenAd(CategorySports.this);


        GameHomeList.SportsList();
    ...
    private class SportsAdapter extends BaseAdapter {
        ...
        public SportsAdapter() {
            this.inflater = (LayoutInflater) CategorySports.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        }
        ...
        public View getView(final int i, View view, ViewGroup viewGroup) {
            ...
            String SportsName = mHashMap.get("SportsName");
            String SportsImg = mHashMap.get("SportsImg");
            String SportsUrl = mHashMap.get("SportsUrl");

            if (tvTitle != null) tvTitle.setText(SportsName);
            if (imgIcon != null && SportsImg != null) {
                int drawable = Integer.parseInt(SportsImg);
            ...
            if (layItemView != null) {
                layItemView.setOnClickListener(v -> {
                    if (SportsUrl != null && SportsUrl.length() > 5) {
                        GameLoader.game_url = SportsUrl;
                        targetActivity = new Intent(CategorySports.this, GameLoader.class);
                    ...
                    if (Admob.mInterstitialAd == null) startActivity(targetActivity);
                        ...
                        startActivity(targetActivity);
                    else Admob.mInterstitialAd.show(CategorySports.this);
